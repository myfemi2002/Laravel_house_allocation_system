@php
$msg = App\Models\RoomNum::orderBy('id','desc')->where('msg_status','2')->get();
@endphp
...
<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            <a href="{{ route('occupant.view') }}">
                <div class="parent-icon"><i class='bx bx-message-square-edit'></i>
                </div>
                <div class="menu-title">All Occupants <span class=" badge rounded-pill bg-danger"> New </span></div>
            </a>
        </li>


        <li>
            <a href="{{ route('apartment.view') }}">
                <div class="parent-icon"><i class='bx bx-category'></i>
                </div>
                <div class="menu-title">Manage Estate</div>
            </a>
        </li>

        <li>
            <a href="{{ route('block.view') }}">
                <div class="parent-icon"><i class='bx bx-cookie'></i>
                </div>
                <div class="menu-title">Manage Block</div>
            </a>
        </li>
        ...
        <li>
            <a href="{{ route('room.view') }}">
                ...
                <div class="menu-title">Manage Flat</div>
            </a>
        </li>

        <li>
            <a href="{{ route('accessories.view') }}">
                <div class="parent-icon"><i class='bx bx-diamond'></i>
                </div>
                <div class="menu-title">Manage Flat Accessories</div>
            </a>
        </li>
        ...
        <li>
            <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">Assign Flat </div>
            </a>
            <ul>
                <li> <a href="{{ route('assign.approved.list') }}"><i class="bx bx-right-arrow-alt"></i>Approved Occupants</a>
                </li>
                <li> <a href="{{ route('assign.view') }}"><i class="bx bx-right-arrow-alt"></i>Assign Occupants</a>
                </li>
                <li> <a href="{{ route('assign.pending.list') }}"><i class="bx bx-right-arrow-alt"></i>Pending Approval</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">Manage Message </div>
            </a>
            <ul>
                <li>
                    <a href="{{ route('message.view') }}"><i class="bx bx-right-arrow-alt"></i>Send Approve Message
                        <span class=" badge rounded-pill bg-danger">  {{ count($msg) }} </span>
                    </a>
                </li>


                <li> <a href="{{ route('sent-message.view') }}"><i class="bx bx-right-arrow-alt"></i>Sent Messages</a></li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route('shop.view') }}"><i class="bx bx-right-arrow-alt"></i>Shop Name</a></li>
                <li> <a href="{{ route('shopnumb.view') }}"><i class="bx bx-right-arrow-alt"></i>Shop Numb</a></li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route('office.view') }}"><i class="bx bx-right-arrow-alt"></i>Office Name</a></li>
                <li> <a href="{{ route('officenumb.view') }}"><i class="bx bx-right-arrow-alt"></i>Office Numb</a></li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href=""><i class="bx bx-right-arrow-alt"></i>Assign Roles</a></li>
                {{-- <li> <a href="{{ route('shopnumb.view') }}"><i class="bx bx-right-arrow-alt"></i>Shop Numb</a></li> --}}
            </ul>
        </li>
