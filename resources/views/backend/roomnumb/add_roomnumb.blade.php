...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xl-9 mx-auto">
            <div class="card">
                <div class="card-body">
                    <form id="myForm" method="post" action="{{ route('room.store') }}" enctype="multipart/form-data" >
                        @csrf
                        <div class="row mb-3">
                            <div class="col-sm-3">
                                <h6 class="mb-0">Estate Name</h6>
                            </div>
                            <div class="col-sm-9">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <input type="text" name="room_num" class="form-control" value="Room-"  placeholder="Flat-1" />
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <input type="text" name="room_accessories"  class="form-control" value="{{ $roomaccessory->room_accessories_name }}" data-role="tagsinput" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-3"></div>
                            <div class="col-sm-9 text-secondary">
                                <input type="submit" class="btn btn-primary px-4" value="Save Flat">
                            </div>
                        </div>
                    </form>
                </div>
